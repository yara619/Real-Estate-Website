...
<head>
<title>Gilgit Real Estate Agency</title>
<meta charset="UTF-8" />
        ...
        <div class="sl-slider">
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="-25" data-slice2-rotation="-25" data-slice1-scale="2" data-slice2-scale="2">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">2 Kanal Plot</a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Gilgit,Pakistan</p>
              <p>This plot is on the backside of Lalik Jan Stadium and it is the best place for you to have a home there.</p>
              <cite>Pkr 70,000,000</cite>
              </blockquote>
            </div>
          </div>
          ...
          <div class="sl-slide" data-orientation="vertical" data-slice1-rotation="10" data-slice2-rotation="-15" data-slice1-scale="1.5" data-slice2-scale="1.5">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">3 Shops for sale </a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> NLI Market Gilgit, Pakistan</p>
              <p>Want to boost up your Business? NLI market is the place to do that.</p>
              <cite>PKR 50,000,000-Each</cite>
              </blockquote>
            </div>
          </div>
          ...
          <div class="sl-slide" data-orientation="horizontal" data-slice1-rotation="3" data-slice2-rotation="3" data-slice1-scale="2" data-slice2-scale="1">
            <div class="sl-slide-inner">
              ...
              <h2><a href="#">3 Bed Rooms, 1 Dinning Room, and Kitchen House on Sale</a></h2>
              <blockquote>
              <p class="location"><span class="glyphicon glyphicon-map-marker"></span> Konodass Gilgit, Pakistan</p>
              <p>The location of this jouse is unique. Have access to all the basic needs at an ease .</p>
              <cite>Pkr 80,000,000</cite>
              </blockquote>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-sm-4">
             <select name="search_price" class="form-control">
                <option>Price</option>
                <option value="1">PKR 5000 - PKR 50,000</option>
                <option value="2">PKR 50,000 - PKR 100,000</option>
                <option value="3">PKR 100,000 - PKR 200,000</option>
                <option value="4">PKR 200,000 - above</option>
              </select>
            </div>
            <div class="col-lg-3 col-sm-4">
...
<div class="row">
            ...
            <div class="col-lg-3 col-sm-3">
             ...
             <div class="col-lg-3 col-sm-3">
                    <h4>Contact us</h4>
                    <p><b>Gilgit real Estate</b><br>
<span class="glyphicon glyphicon-map-marker"></span> Shahrah-e-Quaidazam, Jutilal, 15100,Gilgit <br>
<span class="glyphicon glyphicon-envelope"></span>grs.agency@gmail.com<br>
<span class="glyphicon glyphicon-earphone"></span> +92090078601</p>
            </div>
        </div>
